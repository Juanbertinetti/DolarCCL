    <footer>
        <div class="container d-flex flex-wrap justify-content-between align-items-center py-2 my-4">
            <div class="col-md-4 d-flex align-items-center">
                <img src="/images/logo.png" width="80px" alt="logo" id="m-iso-2">
                <span class="text-muted"><span id="copyleft">©</span> <?= date('Y') ?> - Desarrolado por los mejores programadores de TP</span>
            </div>
